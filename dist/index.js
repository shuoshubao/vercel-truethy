(() => {
  ...
  var CopyOutlined_default2 = /* @__PURE__ */ React4.forwardRef(CopyOutlined2);
  ...
  var columns = [
    {
      ...
      render(value) {
        ...
        return /* @__PURE__ */ import_react3.default.createElement(import_antd.Tag, { style: { margin: 0 }, color: ColorsMap[Method] }, Method);
      }
    },
    {
      title: "Url",
          ...
          import_antd.Button,
          {
            ...
            onClick: () => {
              import_antd.Modal.info({
                ...
                width: "50vw",
                closable: true,
                content: /* @__PURE__ */ import_react3.default.createElement("pre", { style: { padding: 12, background: "#f9fafb", borderRadius: 4 } }, /* @__PURE__ */ import_react3.default.createElement("code", null, JSON.stringify(value, null, 2)))
              });
            }
          },
          "\u67E5\u770B"
          ...
          import_antd.Button,
          {
            ...
            onClick: () => {
              import_antd.Modal.info({
                ...
                width: "90vw",
                closable: true,
                content: /* @__PURE__ */ import_react3.default.createElement("pre", { style: { padding: 12, background: "#f9fafb", borderRadius: 4 } }, /* @__PURE__ */ import_react3.default.createElement("code", null, value))
              });
            }
          },
          "\u67E5\u770B"
  ...
  var views_default = (props) => {
    const { PUBLIC_PATH, RouterList } = Object.keys(props).length ? props : (0, import_lodash.get)(window, "globalData");
    return /* @__PURE__ */ import_react3.default.createElement(import_antd.ConfigProvider, { componentSize: "small" }, /* @__PURE__ */ import_react3.default.createElement(
      import_antd.Card,
      {
        title: "API",
        extra: /* @__PURE__ */ import_react3.default.createElement(import_antd.Tooltip, { title: "api url prefix" }, /* @__PURE__ */ import_react3.default.createElement(
          CopyOutlined_default2,
          {
            onClick: () => {
              (0, import_copy_to_clipboard.default)(PUBLIC_PATH);
              import_antd.message.success(["\u590D\u5236\u6210\u529F", PUBLIC_PATH].join(":"));
            }
          }
        ))
      },
      /* @__PURE__ */ import_react3.default.createElement(import_antd.Table, { rowKey: "url", columns, dataSource: RouterList })
    ));
  };

  // src/index.jsx
  (0, import_client.hydrateRoot)(document.querySelector("#app"), /* @__PURE__ */ import_react4.default.createElement(views_default, null));
})();
